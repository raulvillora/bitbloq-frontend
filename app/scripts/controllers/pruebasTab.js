...
/**
 * @ngdoc function
 * @name bitbloqApp.controller:pruebasTab
 * @description
 * # pruebasTab
 * Controller of the components list
 */
angular.module('bitbloqApp')
    .controller('pruebasTab', pruebasTab);

function pruebasTab($rootScope, $scope, $document, $log, hw2Bloqs, alertsService, _, utils, $translate, $window, $timeout, bloqsUtils, hardwareService, userApi, projectService) {
