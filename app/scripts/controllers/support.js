...
angular.module('bitbloqApp')
    .controller('SupportCtrl', function($scope, $location, $routeParams, common) {
        var db = [
          {
            ...
            'next': [{
              ...
              'data': '<p>¿Has <strong>refrescado la caché</strong> del navegador?</p><p>La caché del navegador es una función que tienen los principales navegadores web, que permite cargar las páginas web más rápido guardando en el ordenador parte de la información que previamente se ha solicitado</p><p>Para <i>refrescar la cache</i>:</p><ul>' + '<li class="icon--windows"><strong> Windows:</strong><p>Presiona la combinación de teclas <span class="icon--fx--keycap">Ctrl</span> + <span class="icon--fx--keycap">⇧ Mayús</span> + <span class="icon--fx--keycap">R</span>, y <strong>vuelve a repetir la acción justo en el momento en el que lapágina comienza a cargarse</strong></p></li>' + '<li class="icon--mac"><strong> Mac:</strong><p>Presiona la combinación de teclas <span class="icon--fx--keycap">⌘ CMD</span> + <span class="icon--fx--keycap">⇧ Mayus.</span> + <span class="icon--fx--keycap">R</span>, y <strong>vuelve a repetir la acción justo en el momento en el que lapágina comienza a cargarse</strong></p></li>' + '<li class="icon--linux"><strong> Linux:</strong></strong><p>Presiona la combinación de teclas <span class="icon--fx--keycap">Ctrl</span> + <span class="icon--fx--keycap">⇧ Mayús</span> + <span class="icon--fx--keycap">R</span>.<br>También puedes probar a presionar la tecla <span class="icon--fx--keycap">⇧ Mayús.</span> y haz clic en el botón “Recargar esta página” en la barra de herramientas de navegación.</p></li></ul><p><strong>¿Refrescar la caché ha solucionado el problema?</strong></p>',
              'next': [{
                  '_id': 'Support--End',
                  'class': 'btn--primary',
        ...
        if ($scope.card === undefined || $scope.card.title === '') {
          $scope.card = db.filter(card => card._id === 'Support--404').pop()
