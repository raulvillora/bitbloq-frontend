...
class LuminiscenceSensor(object):
	...
	def startMeasuring(self, communications, measurementFrequency):
		"""must send a command to start reading the optical density sensor, taking samples at "measuremntFrequency" Hz. 
	...
	def getMeasurement(self, communications):
		"""must return the luminiscence measured in cd.
