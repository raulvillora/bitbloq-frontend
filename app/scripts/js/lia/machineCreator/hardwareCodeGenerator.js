...
function extractWorkingValues(block) {
    ...
    if (block != null) {
        ...
        workingValues.decimalPrecission = block.decimalPrecission;

        workingValues.maxRate = {};
        workingValues.maxRate.value = block.maxRange;
        workingValues.maxRate.volumeUnits = block.maxRangeVolumeUnits;
        workingValues.maxRate.timeUnits = block.maxRangeTimeUnits;

        workingValues.defaultRate = {};
        workingValues.defaultRate.value = block.defaultRate;
        workingValues.defaultRate.volumeUnits = block.defaultRateVolumeUnits;
        workingValues.defaultRate.timeUnits = block.defaultRateTimeUnits;
    }
