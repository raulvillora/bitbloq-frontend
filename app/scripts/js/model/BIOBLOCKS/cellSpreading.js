	...
	onchange: function() {
    	...
    	if(blockDestination!=null){
        	...
        	blockDestination.setParent(null);//Remove the parent of its own parameters
				var dx3 = Blockly.SNAP_RADIUS * (blockDestination.RTL ? -1 : 1);//calculate the movement of the block in x axis
			    var dy3 = Blockly.SNAP_RADIUS * 2;//calculate the movement of the block in x axis
			    blockDestination.moveBy(dx3, dy3); //Move the block with the measures gotten.		
	        	...
	        	blockDestination.setParent(null);//Remove the parent of its own parameters
					var dx4 = Blockly.SNAP_RADIUS * (blockDestination.RTL ? -1 : 1);//calculate the movement of the block in x axis
				    var dy4 = Blockly.SNAP_RADIUS * 2;//calculate the movement of the block in x axis
				    blockDestination.moveBy(dx4, dy4); //Move the block with the measures gotten.
			    }
    		}
		}
	},
