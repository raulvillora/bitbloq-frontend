...
Blockly.Blocks['oligosynthesize'] = {
	...
	init: function() {
		...
		this.appendDummyInput()
			...
			.appendField("OLIGOSYNTHESIZE","blockTitle");
	...
	createFieldsObject : function() {
		...
		fieldsObject["destination"] = this.getFieldValue("DESTINATION");
		fieldsObject["sequence"] = this.getFieldValue("SEQUENCE");
		fieldsObject["scale"] = this.getFieldValue("SCALE");
		fieldsObject["purification"] = this.getFieldValue("PURIFICATION");
